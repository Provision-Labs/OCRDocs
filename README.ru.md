...
| `default`   | Универсальный шаблон  | blocks, tables     | image, pdf(all)        |
...
Присутствует при обработке шаблона `default` (общие документы с таблицами) и `agreement`. `cells` — двумерный массив строк и столбцов.
